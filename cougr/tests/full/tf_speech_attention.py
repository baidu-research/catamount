...
def test_tf_speech_attention():
    graph_meta = 'cougr/frameworks/example_graphs/tensorflow/full_models/speech_attention/model.ckpt.meta'
    ...
    # TODO: Currently, CouGr doesn't automatically handle Tensorflow TensorArrays
    ...
    graph.bindTensorShapeDimensions(bind_dict, warn_if_ill_defined=True, make_symbolic=True)
    assert graph.isValid()
    ...
    pickle.dump(graph, open('cougr/frameworks/example_graphs/tensorflow/full_models/speech_attention/graph_speech_attention.p', 'wb'))
