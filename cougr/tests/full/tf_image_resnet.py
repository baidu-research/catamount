...
from cougr.ops.math_ops import MaximumOp
...
def run_tf_image_resnet(depth, filter_scale=1.0):
    ...
    test_outputs_dir = 'cougr/frameworks/example_graphs/tensorflow/full_models/image_classification'
    graph_meta = None
    ...
    pickle.dump(graph, open('cougr/frameworks/example_graphs/tensorflow/full_models/image_classification/graph_image_resnet_d{}_fs{}.p'.format(depth, filter_scale), 'wb'))
